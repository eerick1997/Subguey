...
public class MyImages {
     ...
     * images fused                                 **/
    private Bitmap createIconMarker(String idStation){
        ...
        Bitmap small1 = Bitmap.createScaledBitmap(bitmap1, 70, 70, false);
        ...
        canvas.drawBitmap(small1, 90f, 80f, null);
        return  bresult;
    }
}
